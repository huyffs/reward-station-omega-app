...
>
	<div class="flex" use:clickOutsideAction={closeOnClickOutside}>
		<button
			...
			class="relative flex-shrink-0 overflow-hidden z-10 whitespace-nowrap inline-flex items-center py-2.5 px-4 text-sm font-medium text-center border input rounded-r-none"
			type="button"
			role="combobox"
			...
			>
				...
				>
					<input
						...
						type="text"
						class="px-4 py-2 w-full sticky top-0 card bg-primary !rounded input"
	...
	<TelInput
		...
		{options}
		required
		class="text-sm card input rounded-l-none block w-full p-2.5"
	/>
</div>